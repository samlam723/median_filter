...
analyze -format verilog {N5R8_median_filter.v}
elaborate median_filter; # top module name

# store the unmapped results
write -hierarchy -format ddc -output results/N5R8_median_filter.unmapped.ddc
...
source median_filter.constraints.tcl
...
check_design > reports/N5R8_median_filter.check_design.rpt; # dump to the file
...
# Write out design
write -format verilog -hierarchy -output results/N5R8_median_filter.mapped.v
write -format ddc -hierarchy -output results/N5R8_median_filter.mapped.ddc
write_sdf results/N5R8_median_filter.mapped.sdf
write_sdc -nosplit results/N5R8_median_filter.mapped.sdc

# Generate reports
report_qor > reports/N5R8_median_filter.mapped.qor.rpt
report_timing -transition_time -nets -attribute -nosplit \
  > reports/N5R8_median_filter.mapped.timing.rpt
report_area -nosplit > reports/N5R8_median_filter.mapped.area.rpt
report_power -nosplit > reports/N5R8_median_filter.mapped.power.rpt
