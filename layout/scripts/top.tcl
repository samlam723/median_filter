...
# N5R8_median_filter. The P&R flow is based on the EDI 13.1 official workshop and use the
...
set init_verilog "designs/N5R8_median_filter.mapped.v"
...
floorPlan -r 1 0.6 8 8 8 8

# Load IO assignment file: N5R8_median_filter.ioc
# It specifies the relative location of module pins and on which metal layer you
# are preferred to place your module pins
loadIoFile "scripts/N5R8_median_filter.ioc" -noAdjustDieSize
# Save the checkpoint for floorplan
saveDesign db/N5R8_median_filter_floorplan.enc
...
# starting from the left offset 20.0 (roughly middle of the N5R8_median_filter module)
...
saveDesign db/N5R8_median_filter_powerplan.enc
...
saveDesign db/N5R8_median_filter_place.enc
...
saveDesign db/N5R8_median_filter_cts.enc
...
saveDesign db/N5R8_median_filter_postroute.enc
...
verifyGeometry -report reports/N5R8_median_filter.geometry.rpt
verifyConnectivity -type all -report reports/N5R8_median_filter.connectivity.rpt
...
report_area -out_file reports/N5R8_median_filter.routed.area.rpt

# Power report
report_power -outfile reports/N5R8_median_filter.routed.power.rpt

# ------------------------------------------------------------------------------
# Step 7b. Exports the design
# ------------------------------------------------------------------------------
# SPEF file: parastic data of wires
rcOut -spef results/N5R8_median_filter.spef -rc_corner rc_worst

# SDF file: delay files for gates and wires
write_sdf results/N5R8_median_filter.sdf

# *.v: verilog netlist file
saveNetlist results/N5R8_median_filter.routed.v

# *.gds: GDS file
streamOut results/N5R8_median_filter.gds -mapFile streamOut.map \
